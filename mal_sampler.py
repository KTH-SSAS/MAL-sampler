...
from sample_metamodel import sample_metamodel
...
if __name__ == "__main__":
    metamodel = sample_metamodel(size_factor=40)
    ...
    model.plot(MODEL_FILE_NAME)
    print(f'# Model plotted in {MODEL_FILE_NAME}.')
